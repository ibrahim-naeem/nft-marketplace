...
import { create as ipfsHttpClient } from "ipfs-http-client";//by using this we will upload and download file
  ...
  return (
    <div className="flex justify-center">
      <div className="w-1/2 flex flex-col pb-12">
        ...
        <button
          onClick={createItem}
          className="font-bold mt-4 bg-slate-400 text-white rounded p-4 shadow-lg"
        >
          Create NFT
        </button>
      </div>
