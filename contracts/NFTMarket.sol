...
contract NFTMarket is ReentrancyGuard{
    ...
    function createMarketItem(address nftContract, uint tokenId, uint price) public payable nonReentrant {
        ...
        //while calling this function user will send some amount for listing fee
        require(msg.value  == listingPrice, "Price mus be equal to listing price");
    ...
    function createMarketSale(address nftContract, uint itemId) public payable nonReentrant{
        ...
        require(msg.value == price, "Please submit the asking price to compelete the process");
